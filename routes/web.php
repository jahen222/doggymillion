...
Route::get('123RRdoggymillonRR456register', ['as'=> '123RRdoggymillonRR456register', 'uses' => 'DogsController@Registerhidden']);
Route::post('123RRdoggymillonRR456register', ['as'=> '123RRdoggymillonRR456register', 'uses' => 'DogsController@Store']);
Route::get('123RRdoggymillonRR456deleted/{id}', ['as'=> '123RRdoggymillonRR456deleted', 'uses' => 'DogsController@Deletedhidden']);
